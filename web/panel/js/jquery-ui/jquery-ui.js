    ...
    var tabs = $.widget("ui.tabs", {
        ...
        _refresh: function () {
            ...
            if (!this.active.length) {
                ...
                this.active
                    .addClass("active ui-tabs-active ui-state-active")
                    .attr({
                        "aria-selected": "true",
                        "aria-expanded": "true",
                        tabIndex: 0
        ...
        _toggle: function (event, eventData) {
            ...
            function show() {
                eventData.newTab.closest("li").addClass("active ui-tabs-active ui-state-active");
            ...
            if (toHide.length && this.options.hide) {
                this._hide(toHide, this.options.hide, function () {
                    eventData.oldTab.closest("li").removeClass("active ui-tabs-active ui-state-active");
                    show();
                });
            } else {
                eventData.oldTab.closest("li").removeClass("active ui-tabs-active ui-state-active");
