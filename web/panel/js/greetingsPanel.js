            ...
            if (panelCheckQuery(msgObject, 'greetings_gamewispTiers')) {
                ...
                for (idx in msgObject['results']) {
                    ...
                    html = '<tr >' +
                        ...
                        '    </td>' +
                        '</tr>';
                    if (key.startsWith('songrequest_') === true) {
                        songRequestHtml += html;
                    }
                    if (key.startsWith('bonuspoints_') === true) {
                        bonusPointsHtml += html;
                    }
                    if (key.startsWith('subbonuspoints_') === true) {
                        subBonusPointsHtml += html;
                    }
                }
